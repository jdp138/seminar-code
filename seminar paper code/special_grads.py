...
# Check if the gradient has already been registered
if "MaxPoolGrad" not in ops._gradient_registry._registry:
    ...
    print("MaxPoolGrad gradient is already registered.")
